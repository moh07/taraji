...
import com.olivapps.taraji.fragement.videos.videos;
...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    private final videos.LastItemReachedListener mListener;
    ...
    public PlaylistCardAdapter(PlaylistVideos playlistVideos, videos.LastItemReachedListener lastItemReachedListener) {
